...
- [docs/LUA_API.md](docs/LUA_API.md) - API Lua complète
- [docs/MODEL_ARCHITECTURES.md](docs/MODEL_ARCHITECTURES.md) - Architectures disponibles
...
- API Lua : [docs/LUA_API.md](docs/LUA_API.md)
