...
---Effectue un train step PonyXL-DDPM.
---@param prompt string
...
---@return {loss:number, grad_norm:number, grad_max_abs:number, timestep:number, kl_divergence:number}|nil stats
---@return string? err
function Mimir.Model.ponyxl_ddpm_train_step(prompt, image_u8, width, height, learning_rate, optimizer, metadata) end

---Validation step PonyXL-DDPM.
---@param prompt string
---@param wrong_prompt string|nil
---@param image_u8 integer[]
---@param width integer
---@param height integer
---@param seed? integer
---@param ddpm_step? integer
---@return table|nil stats
---@return string? err
function Mimir.Model.ponyxl_ddpm_validate_step(prompt, wrong_prompt, image_u8, width, height, seed, ddpm_step) end
...
---@return string? err
function Mimir.Model.ponyxl_ddpm_viz_reconstruct_step(prompt, image_u8, width, height, label, max_side, seed, ddpm_step) end
